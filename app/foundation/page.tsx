  ...
  return (
    <div>
      ...
      <div className='mt-[10vh] relative min-h-screen'>
        ...
        <div className='z-30 text-[0.7rem] md:text-base text-slate-300 bg-transparent w-[70%] md:w-[60%] mx-auto text-center pt-[3vh] md:pt-[4vh]'>Comprehensive coaching for classes 6 to 12 Build a strong foundation with expert faculty.</div>
