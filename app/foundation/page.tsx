  ...
  return (
    <div>
      ...
      <div className='mt-[10vh] relative min-h-screen'>
        ...
        <div className='z-30 text-xl md:text-5xl font-medium md:font-normal text-slate-200 bg-transparent w-[80%] md:w-[60%] mx-auto text-center pt-[20vh] md:pt-[25vh]'>Achieve Success in IIT JEE & Medical Entrance Exams</div>
