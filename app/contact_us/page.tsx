      ...
      <div className='mt-[10vh] relative bg-gray-100 min-h-screen'>
        <div className="px-6 py-12">
          ...
          <div className="mb-12">
            ...
            <p className='text-gray-700'>WhatsApp Business: 7349850556</p>
            <p className='text-gray-700'>Email: samatva.edu20@gmail.com</p>
            <div className="mt-4 border-2 border-teal-700">
              <iframe 
